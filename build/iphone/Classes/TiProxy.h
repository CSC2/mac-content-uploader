...
//Rare exceptions to indicate a bug in the _mac_content_uploader code (Eg, function that a subclass should have implemented)
...
/**
 The base class for mac_content_uploader proxies.
 */
