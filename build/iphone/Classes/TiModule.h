...
/**
 The base class for all mac_content_uploader modules
 */
...
/**
 mac_content_uploader Platform calls this method on startup.
 */
-(void)startup;

/**
 mac_content_uploader Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 mac_content_uploader Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 mac_content_uploader Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 mac_content_uploader Platform calls this method on resume.
 @param sender The sender of the event.
 */
