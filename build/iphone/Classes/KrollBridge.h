...
@interface mac_content_uploaderObject : KrollCoverageObject {
#else
@interface mac_content_uploaderObject : KrollObject {
#endif
@private
...
extern NSString * mac_content_uploader$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	mac_content_uploaderObject *_mac_content_uploader;
    KrollObject* console;
	BOOL shutdown;
