...
//@interface mac_content_uploaderObject : NSObject
//@end

@interface mac_content_uploaderObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[mac_content_uploaderObject class]])
		{
			for (NSString *key in [[(mac_content_uploaderObject*)o modules] allKeys])
			{
