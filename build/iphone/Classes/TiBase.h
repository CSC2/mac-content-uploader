...
// in simulator we redefine to format for mac_content_uploader Developer console
...
{\
	NSString * exceptionName = [@"org.mac_content_uploader." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mac_content_uploader";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UImac_content_uploaderNativeItemNone = -1, 
	UImac_content_uploaderNativeItemSpinner = -2,
	UImac_content_uploaderNativeItemProgressBar = -3,
	
	UImac_content_uploaderNativeItemSlider = -4,
	UImac_content_uploaderNativeItemSwitch = -5,
	UImac_content_uploaderNativeItemMultiButton = -6,
	UImac_content_uploaderNativeItemSegmented = -7,
	
	UImac_content_uploaderNativeItemTextView = -8,
	UImac_content_uploaderNativeItemTextField = -9,
	UImac_content_uploaderNativeItemSearchBar = -10,
	
	UImac_content_uploaderNativeItemPicker = -11,
	UImac_content_uploaderNativeItemDatePicker = -12,
	
	UImac_content_uploaderNativeItemInfoLight = -13,
	UImac_content_uploaderNativeItemInfoDark = -14,
	
	UImac_content_uploaderNativeItemDisclosure = -15,
	
	UImac_content_uploaderNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all mac_content_uploader instances of
