...
MAKE_SYSTEM_PROP(ACTIVITY,UImac_content_uploaderNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UImac_content_uploaderNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UImac_content_uploaderNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UImac_content_uploaderNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UImac_content_uploaderNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UImac_content_uploaderNativeItemContactAdd);
